...
export class CreateCommentUseCase
  implements ICommandHandler<CreateCommentCommentsCommand>
{
  constructor(
  ...
  async execute(
    command: CreateCommentCommentsCommand,
    ...
    const createdComment = await this.commentsRepository.createNewComment(
      comment,
    );
