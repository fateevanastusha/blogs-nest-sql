...
import {
  BannedUserInfo,
  BlogModel,
  CreateBannedUserInfo,
  PaginatedClass,
} from '../../blogs/schemas/blogs.schema';
...
export class BloggersUsersService {
  ...
  async getAllBannedUsers(
    ...
    const bannedUsers: BannedUserInfo[] =
      await this.queryRepository.paginationForBlogBannedUsers(query, blogId);
